...
- (instancetype)init {
    ...
    if (self) {
        ...
        praiseLabel.linkTextAttributes = @{NSForegroundColorAttributeName:[UIColor colorWithRed:92/255.0 green:140/255.0 blue:255/255.0 alpha:1]};
        ...
        [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.praiseLabel.mas_bottom).offset(5);
            make.left.right.equalTo(self);

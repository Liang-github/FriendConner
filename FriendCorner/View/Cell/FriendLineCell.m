...
@property (nonatomic, strong) ContainView *imageViewContainView;
...
- (void)setup {
    ...
    [moreBtn setTitle:@"全文" forState:0];
    [moreBtn setTitle:@"收起" forState:UIControlStateSelected];
    [moreBtn setTitleColor:[UIColor colorWithRed:92/255.0 green:140/255.0 blue:193/255.0 alpha:1] forState:0];
    ...
    [nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(msgLabel.mas_top).offset(-5);
    }];
    // 文字信息
    ...
    [moreBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(msgLabel.mas_bottom);
        make.left.mas_equalTo(msgLabel);
    }];
    // 图片
    [containView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(moreBtn.mas_bottom).offset(10);
        make.left.equalTo(moreBtn);
    }];
    [operationBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.imageViewContainView.mas_bottom).offset(10);
        make.right.equalTo(self.msgLabel);
        make.size.mas_equalTo(CGSizeMake(25, 25));
    }];
    // 喜欢和评论按钮
    [opView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.imageViewContainView.mas_bottom).offset(5);
    ...
    [comView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.operationView.mas_bottom).offset(5);
